...
class VentanaAgregarHabito:
    ...
    def crear_frame_derecho(self): 
        self.frame_derecho = ctk.CTkFrame(self.master, corner_radius=styles.CORNER_RADIUS)
    ...
    def nombre_habito(self): 
        ...
        label_nombre.grid(column=0, row=0, sticky="nsew", padx=styles.PADX, pady=styles.PADY)
        self.entry_nombre = ctk.CTkEntry(self.frame_izq_agregar_hab,
                                    font=styles.FUENTE_PEQUEÑA,
                                    )
        self.entry_nombre.grid(column=0, row=1, sticky="nsew", padx=styles.PADX, pady=styles.PADY)
    ...
    def color_habito(self): 
        ...
        label_nombre.grid(column=0, row=2, sticky="nsew", padx=styles.PADX, pady=styles.PADY)

        frame_colores = ctk.CTkFrame(self.frame_izq_agregar_hab)
        frame_colores.grid(column=0, row=3, sticky="nsew", padx=styles.PADX, pady=styles.PADY)

        self.btn_colores_estado = {}   # {color: boton}
        self.color_seleccionado = None

        for color in styles.COLORES:
        ...
        if styles.COLORES[0] in self.btn_colores_estado:
            self.evento_btn_color(styles.COLORES[0])
    ...
    def crear_frame_semana(self): 
        ...
        self.frame_selec_semana.grid(column=0, row=0, sticky="nsew",
                                    padx=styles.PADX, pady=styles.PADY)
    ...
    def dias_repeticion(self):
        ...
        label_semana.grid(column=0,columnspan =2, row=0, sticky="nsew", padx=styles.PADX, pady=styles.PADY)
        boton_seleccionar_todos = ctk.CTkCheckBox(self.frame_selec_semana, 
                                                  ...
                                                  font=styles.FUENTE_PEQUEÑA)
        boton_seleccionar_todos.grid(column=1, row=2, sticky="e", padx=40, pady=styles.PADY)

        self.frame_dias_semana = ctk.CTkFrame(self.frame_selec_semana)
        self.frame_dias_semana.grid(column=0,columnspan=2 ,row=1, sticky="nsew", padx=styles.PADX, pady=styles.PADY)
    ...
    def agregar_descripcion(self):
        ...
        label_descripcion.grid(column=0,columnspan =2, row=3, sticky="nsew", padx=styles.PADX, pady=styles.PADY)
        ...
        self.cuadro_texto_descripcion.grid(column=0,columnspan =2, row=4, sticky="nsew", padx=styles.PADX, pady=styles.PADY)
    ...
    def crear_frame_botones_navegacion(self): 
        ...
        boton_cancelar = ctk.CTkButton(self.frame_botones_navegacion,
                                       ...
                                       font=styles.FUENTE_SUBTITULOS)
        boton_cancelar.grid(column=0, row=0, sticky="nsew", padx=styles.PADX, pady=styles.PADY)
        boton_agregar_habito = ctk.CTkButton(self.frame_botones_navegacion,
                                            text="AGREGAR HABITO",
                                            #fg_color=estilos.COLOR_CONTRASTE,
                                            command=self.evento_btn_crear_habito,
                                            font=styles.FUENTE_SUBTITULOS)
        boton_agregar_habito.grid(column=1, row=0, sticky="nsew", padx=styles.PADX, pady=styles.PADY)
...
#----------------------------------------------------EVENTOS-------------------------------------------------------------------------
    ...
    def evento_btn_semana(self, boton, clave):
        ...
        if boton.selected:
            boton.configure(border_width=4, border_color=styles.COLOR_BORDE)
        else:
    ...
    def evento_btn_color(self, color):
        ...
        boton_seleccionado.configure(border_width=4, border_color=styles.COLOR_BORDE)
    ...
    def evento_habito_sin_ejecuciones(self):
        label_error = ctk.CTkLabel(self.frame_selec_semana, 
                                                  ...
                                                  text_color="red",
                                                  font=styles.FUENTE_PEQUEÑA)
        label_error.grid(column=0, row=2, sticky="w", padx=40, pady=styles.PADY)
